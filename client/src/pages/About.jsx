  ...
  return (
    <div className='py-20 px-4 max-w-6xl mx-auto'>
      ...
      <p className='mb-4 text-slate-700'>
        AdityaEstate is a leading real estate agency that specializes in helping 
      ...
      <p className='mb-4 text-slate-700'>
      Our team of agents has a wealth of experience 
      and knowledge in the real estate industry, and we are committed to providing the 
      highest level of service to our clients. We believe that buying or selling a 
      property should be an exciting and rewarding experience, and we are dedicated to
